...
public class SetAlarmV3Activity extends BaseAutoConnectActivity  implements android.widget.CompoundButton.OnCheckedChangeListener {
    ...
    private SettingCallBack.ICallBack iCallBack = new SettingCallBack.ICallBack() {
        ...
        public void onSuccess(SettingCallBack.SettingType type, Object returnData) {
            closeProgressDialog();
            Toast.makeText(SetAlarmV3Activity.this, R.string.set_para_tip_msg_ok, Toast.LENGTH_SHORT).show();
            List<AlarmV3> alarms = DataUtils.getInstance().getAlarmV3();
            if (alarms == null){
                alarms = new ArrayList<>();
            }
            alarms.add(mAlarm);
            DataUtils.getInstance().saveAlarmV3(alarms);
        }

        @Override
        public void onFailed(SettingCallBack.SettingType type) {
            closeProgressDialog();
            Toast.makeText(SetAlarmV3Activity.this, R.string.set_para_tip_msg_failed, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_alarm_v3);
