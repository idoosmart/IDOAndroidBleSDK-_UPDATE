package test.com.ido.dfu.customview;
...
public class SpecialProgressBarView extends View {
    ...
    public SpecialProgressBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize =  typedArray.getDimension(R.styleable.SpecialProgressBarStyle_textSize1, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, getResources().getDisplayMetrics()));
