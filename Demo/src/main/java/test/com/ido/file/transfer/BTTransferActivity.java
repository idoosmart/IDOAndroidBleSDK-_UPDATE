...
public class BTTransferActivity extends BaseAutoConnectActivity {

    private TextView tvFilePath, tvProgress,tvFileName;
    String fileName;
    /*
     *
    ...
    public void startTransFile(View view){
        ...
        if(TextUtils.isEmpty(filePath)){
            Toast.makeText(this,"please select bt file",Toast.LENGTH_LONG).show();
            return;
        }
        FileTransferConfig config = FileTransferConfig.getDefaultTransLangFileConfig(filePath, new IFileTransferListener(){
            @Override
            public void onStart() {
        ...
        config.firmwareSpecName = fileName;// fileNAME MUST contain ".bt",example :"ddd.bt"
